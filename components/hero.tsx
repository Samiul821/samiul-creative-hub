...
export default function Hero(): JSX.Element {
  ...
  const socialLinks: SocialLink[] = [
    { icon: CiFacebook, href: 'https://www.facebook.com/md.samiul.islam.work', label: 'Facebook' },
    { icon: CiInstagram, href: 'https://www.instagram.com/md.samiul.islam.official/', label: 'Instagram' },
    { icon: CiLinkedin, href: 'https://www.linkedin.com/in/md-samiul-islam890', label: 'LinkedIn' },
    { icon: FaEnvelope, href: 'mailto:support.samiul.islam@gmail.com', label: 'Email' },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 fade-up">
          ...
          <p className="text-lg text-foreground/80 mb-8 max-w-xl leading-relaxed">
            I'm a passionate Social Media Manager and Digital Marketer helping businesses build strong online presence through creative branding, engaging content, and performance-driven advertising strategies.
          </p>
            ...
            {socialLinks.map((social) => {
              ...
              return (
                <a
                  ...
                  className="glass glass-hover p-3 rounded-lg text-primary hover:text-secondary transition-colors"
                  title={social.label}
                >
                  <Icon size={24} />
                </a>
